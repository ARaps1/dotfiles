...
alias cypr="dev test cypress run"
alias cyprv="cypr --videos"
alias cypra="cypr --update-audit-snapshot"
alias cyprav="cypra --videos"
...
alias cypstart="up && cd services/token-issuer && dev up && cd ../tenant-catalog && dev up && cd /src && web"
alias claudeus="claude --dangerously-skip-permissions"
# alias ll="ls -la"
# alias gs="git status"
# alias gco="git checkout"
